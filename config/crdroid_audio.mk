...
ALARM_PATH := vendor/crdroid/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/crdroid/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/crdroid/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/crdroid/prebuilt/common/media/audio/ui
