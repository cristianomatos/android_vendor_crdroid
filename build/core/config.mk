...
BUILD_MAVEN_PREBUILT := $(TOP)/vendor/crdroid/build/core/maven_artifact.mk
PUBLISH_MAVEN_PREBUILT := $(TOP)/vendor/crdroid/build/core/maven_artifact_publish.mk
